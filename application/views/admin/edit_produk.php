    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-around">
                <div class="col-3">
                    <form method="post" action="<?php echo base_url().'admin/data_produk/update_gambar/' ?>" enctype="multipart/form-data">
                ...
                <div class="col-7">
                    <form method="post" action="<?php echo base_url().'admin/data_produk/update' ?>">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <label for="basic-url" class="form-label"><b>Verifikasi Produk:</b></label>
                                <div class="form-check">
                                    <?php if ($prdk->verifikasi_produk == "Y"){ echo'
                                        <input class="form-check-input" type="radio" name="verifikasi_produk" value="Y" checked>
                                        <label class="form-check-label" for="gridRadios1">
                                            YA
                                        </label></div><div class="form-check">
                                        <input class="form-check-input" type="radio" name="verifikasi_produk" value="N">
                                        <label class="form-check-label" for="gridRadios2">
                                            TIDAK
                                        </label>
                                        </div>';}
                                        else{ echo'
                                            <input class="form-check-input" type="radio" name="verifikasi_produk" value="Y"><label class="form-check-label" for="gridRadios1">
                                                YA
                                            </label></div><div class="form-check">
                                            <input class="form-check-input" type="radio" name="verifikasi_produk" value="N" checked>
                                            <label class="form-check-label" for="gridRadios2">
                                                TIDAK
                                            </label>
                                            </div>';}?>
