...
<h1 class="text-center h4 text-blue-900 mb-4">Login Admin Tukutuku</h1>
<div class="svgContainer">
		<div>
			<svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
				...
				<circle cx="100" cy="100" r="100" fill="#f59292"/>
				<g class="body">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="loginEmail" maxlength="254" name="email_admin"/>
        <?php echo form_error('email_admin', '<div class="text_danger small">','</div'); ?>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password_admin" />
        <?php echo form_error('password_admin', '<div class="text_danger small">','</div>'); ?>
