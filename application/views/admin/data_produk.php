                                ...
                                <table class="table table-bordered" id="table1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <a class='btn btn-success btn-sm' href='<?php echo base_url('admin/data_produk/detail/') .$prdk['id_produk']?>'><span class='fas fa-info-circle'></span></a>
                                          <a class='btn btn-primary btn-sm' href='<?php echo base_url('admin/data_produk/edit/') .$prdk['id_produk']?>'><span class='fas fa-edit'></span></a>
                                          <button type='button' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#delete<?php echo $prdk['id_produk']?>'>
                                            <i class="fas fa-trash"></i>
                                          </button>
                                        </td>
                                      </tr>
                                      <!-- Modal Delete Kategori -->
                                      <div class='modal fade' id='delete<?php echo $prdk['id_produk'] ?>' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
                                        <div class='modal-dialog modal-dialog-centered' role='document'>
                                          <div class='modal-content'>
                                            <div class='modal-header'>
                                              <h5 class='modal-title' id='exampleModalLongTitle'>Hapus Kategori <b>#<?php echo $prdk['id_produk'] ?> </b></h5>
                                              <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                                <span aria-hidden='true'>&times;</span>
                                              </button>
                                            </div>
                                            <div class='modal-body'>
                                              Apakah Anda yakin akan Menghapus Kategori <b>#<?php echo $prdk['id_produk'] ?> </b>?
                                            </div>
                                            <div class='modal-footer'>
                                              <button type='button' class='btn btn-secondary' data-dismiss='modal'>Batal</button>
                                              <a class='btn btn-danger' href='<?php echo base_url('admin/data_produk/hapus/').$prdk['id_produk'] ?>'>Hapus</a>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                            ...
                            <div class="table2">
                                <table class="table table-bordered" id="table2" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                      ...
                                      <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $prdk2['nama_toko'] ?></td>
                                        ...
                                        <td>
                                          <a class='btn btn-success btn-sm' href='<?php echo base_url('admin/data_produk/detail/') .$prdk2['id_produk']?>'><span class='fas fa-info-circle'></span></a>
                                          <a class='btn btn-primary btn-sm' href='<?php echo base_url('admin/data_produk/edit/') .$prdk2['id_produk']?>'><span class='fas fa-edit'></span></a>
                                          <button type='button' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#delete<?php echo $prdk2['id_produk']?>'>
                                            <i class="fas fa-trash"></i>
                                          </button>
                                        </td>
                                      </tr>
                                       <!-- Modal Delete Kategori -->
                                       <div class='modal fade' id='delete<?php echo $prdk2['id_produk'] ?>' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
                                        <div class='modal-dialog modal-dialog-centered' role='document'>
                                          <div class='modal-content'>
                                            <div class='modal-header'>
                                              <h5 class='modal-title' id='exampleModalLongTitle'>Hapus Kategori <b>#<?php echo $prdk2['id_produk'] ?> </b></h5>
                                              <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                                <span aria-hidden='true'>&times;</span>
                                              </button>
                                            </div>
                                            <div class='modal-body'>
                                              Apakah Anda yakin akan Menghapus Kategori <b>#<?php echo $prdk2['id_produk'] ?> </b>?
                                            </div>
                                            <div class='modal-footer'>
                                              <button type='button' class='btn btn-secondary' data-dismiss='modal'>Batal</button>
                                              <a class='btn btn-danger' href='<?php echo base_url('admin/data_produk/hapus/').$prdk2['id_produk'] ?>'>Hapus</a>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                            ...
                            <div class="table3">
                                <table class="table table-bordered" id="table3" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $prdk3['nama_toko'] ?></td>
                                        ...
                                        <td>
                                          <a class='btn btn-success btn-sm' href='<?php echo base_url('admin/data_produk/detail/') .$prdk3['id_produk']?>'><span class='fas fa-info-circle'></span></a>
                                          <a class='btn btn-primary btn-sm' href='<?php echo base_url('admin/data_produk/edit/') .$prdk3['id_produk']?>'><span class='fas fa-edit'></span></a>
                                          <button type='button' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#delete<?php echo $prdk3['id_produk']?>'>
                                            <i class="fas fa-trash"></i>
                                          </button>
                                        </td>
                                      </tr>
                                       <!-- Modal Delete Kategori -->
                                       <div class='modal fade' id='delete<?php echo $prdk3['id_produk'] ?>' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
                                        <div class='modal-dialog modal-dialog-centered' role='document'>
                                          <div class='modal-content'>
                                            <div class='modal-header'>
                                              <h5 class='modal-title' id='exampleModalLongTitle'>Hapus Kategori <b>#<?php echo $prdk3['id_produk'] ?> </b></h5>
                                              <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                                <span aria-hidden='true'>&times;</span>
                                              </button>
                                            </div>
                                            <div class='modal-body'>
                                              Apakah Anda yakin akan Menghapus Kategori <b>#<?php echo $prdk3['id_produk'] ?> </b>?
                                            </div>
                                            <div class='modal-footer'>
                                              <button type='button' class='btn btn-secondary' data-dismiss='modal'>Batal</button>
                                              <a class='btn btn-danger' href='<?php echo base_url('admin/data_produk/hapus/').$prdk3['id_produk'] ?>'>Hapus</a>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(). 'admin/data_produk/tambah_aksi';?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
		        <label for="c_message">Nama Toko<span class="required">*</span></label>
            <select class="form-control mb-3" name="nama_toko" id="id_toko">
                <option value=''>- Pilih -</option>
                <?php foreach($toko as $tko){ ?>
                <option value="<?php echo $tko->id_toko; ?>"><?php echo $tko->nama_toko; ?> </option>
                <?php } ?>
            </select>
