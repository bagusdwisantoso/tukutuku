...
<h1 class="text-center h4 text-blue-900 mb-4">Login Akun</h1>
<div class="svgContainer">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="loginEmail" maxlength="254" name="email_customer"/>
        <?php echo form_error('email_customer', '<div class="text_danger small">','</div'); ?>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password_customer" />
        <?php echo form_error('password_customer', '<div class="text_danger small">','</div>'); ?>
    ...
    <div class="text-center">
        <a class="small" href="<?php echo base_url('registrasi'); ?>"> <h5>Belum Punya Akun? Daftar Disini!</h5></a>
    </div>
</form>
