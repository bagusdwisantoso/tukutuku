...
<form method="post" action="<?php echo base_url('toko/auth_toko/login')?>" class="user">
<h1 class="text-center h4 text-blue-900 mb-4">Login Toko Tukutuku</h1>
<div class="svgContainer">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="loginEmail" maxlength="254" name="email"/>
