...
<h1 class="text-center h4 text-blue-900 mb-4"><center>Daftar Akun</center></h1>
<div class="svgContainer">
		<div>
			<svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
				...
				<circle cx="100" cy="100" r="100" fill="#c60512"/>
				<g class="body">
    ...
    <div class="inputGroup inputGroup1">
		<label for="loginNama" id="loginNamaLabel">Nama Lengkap</label>
		<input type="text" id="loginNama" maxlength="254" name="nama_customer" required>
        <?php echo form_error('nama_customer', '<div class="text_danger small">','</div>'); ?>
    </div>
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="loginEmail" maxlength="254" name="email_customer" required>
        <?php echo form_error('email_customer', '<div class="text_danger small">','</div>'); ?>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password_1" required>
    ...
    <div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel2">Ulangi Password</label>
		<input type="password" id="loginPassword2" name="password_2" required>
        <?php echo form_error('password_2', '<div class="text_danger small">','</div>'); ?>
    </div>
    ...
    <script src="<?php echo base_url() ?>assets/vendor/gsap.min.js"></script>
